...
/**
 * The interactive Stomping Grounds map — SceneBackground, StationHotspot grid,
 * station panel, and mobile card list. Usable on both the /grounds page and the
 * homepage. Pass `compact` to show a minimal header bar with a link to /grounds.
 */
                        ...
                        <div>
                          ...
                          {s.badge != null && (
                            <div className="text-[10px] text-white/40">
                              {s.badge}{" "}
                              {s.id === "wisdom-dig" ? "gems" : s.id === "wishing-well" ? "coins in pot" : "paths"}
                            </div>
                          )}
                        </div>
                      </button>

/**
 * Curated one-line topic summaries for known TSP categories.
 * Keys are lowercase to match case-insensitive category lookups.
 * For any category not listed here, the API falls back to
 * a description derived from the most-recent episode's summary.
 */
...
/**
 * Returns the curated description for a known category, or null.
 * Matching is case-insensitive.
 */
export function getCuratedDescription(category: string): string | null {
  return curatedDescriptions[category.toLowerCase()] ?? null;
}

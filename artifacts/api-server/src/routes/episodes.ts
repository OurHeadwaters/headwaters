  ...
  try {
    ...
    const list = [...counts.entries()]
      ...
      .map(([name, count]) => {
        ...
        const description = dbEntry?.description ?? curated ?? fallback ?? undefined;

        // autoDescriptionStale: true when no curated/DB description exists and the
        // auto-description's source episode is older than 7 days.
        const hasCurated = dbEntry !== null || curated !== null;
        ...
        } else if (!curated && autoEntry !== undefined) {

  ...
  return (
    <View style={{ flex: 1 }}>
      <Tabs
        screenOptions={{
          headerShown: false,
          tabBarActiveTintColor: colors.amberGold,
          tabBarInactiveTintColor: colors.mutedForeground,
          tabBarStyle: {
            position: "absolute",
            backgroundColor: isIOS ? "transparent" : colors.forestDeep,
            borderTopWidth: 2,
          ...
          tabBarBackground: () =>
            isIOS ? (
              ...
              <View
                style={[StyleSheet.absoluteFill, { backgroundColor: colors.forestDeep }]}
              />
            ) : null,
        }}
      >

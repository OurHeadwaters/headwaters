...
export default function WalletScreen() {
  ...
  const handleConnectXaman = async () => {
    ...
    try {
      await Linking.openURL("https://xumm.app");
    } catch {}
  };
  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { paddingTop: topPadding + 16, backgroundColor: colors.primary }]}>
        <Text style={[styles.headerTitle, { color: colors.primaryForeground, fontFamily: "DMSans_700Bold" }]}>
          ⚡ Value Wallet
        </Text>
        <Text style={[styles.headerSub, { color: colors.primaryForeground, fontFamily: "DMSans_400Regular" }]}>
          Support creators you love — pay what you want
        </Text>
        {isSupporter && (
          <View style={[styles.supporterBadge, { backgroundColor: colors.primaryForeground + "20" }]}>
            <Text style={[styles.supporterText, { color: colors.primaryForeground, fontFamily: "DMSans_600SemiBold" }]}>
              ⚡ Supporter
            </Text>
          </View>
        )}
        ...
        <View style={[styles.card, { backgroundColor: colors.muted, borderColor: colors.border }]}>
          <View style={styles.cardRow}>
            <View style={styles.cardLeft}>
              <Text style={[styles.cardLabel, { color: colors.mutedForeground, fontFamily: "DMSans_500Medium" }]}>
                CONNECTED WALLET
              </Text>
            ...
            <View style={styles.inputGroup}>
              ...
              <Pressable
                ...
                style={[
                  styles.connectBtn,
                  {
                    backgroundColor: lightningInput.trim() ? colors.primary : colors.muted,
              ...
              >
                {connecting ? (
                  ...
                  <Text style={[styles.connectBtnText, {
                    color: lightningInput.trim() ? colors.primaryForeground : colors.mutedForeground,
                    fontFamily: "DMSans_600SemiBold",
                  }]}>
                    Connect
                  </Text>
            ...
            <View style={styles.inputGroup}>
              ...
              <Pressable
                ...
                style={[
                  styles.connectBtn,
                  {
                    backgroundColor: xrplInput.trim() ? colors.primary : colors.muted,
                  },
                ]}
              >
                <Text style={[styles.connectBtnText, {
                  color: xrplInput.trim() ? colors.primaryForeground : colors.mutedForeground,
                  fontFamily: "DMSans_600SemiBold",
                }]}>
                  Connect Address
                </Text>
              ...
              <Pressable
                ...
                style={[styles.xamanBtn, { borderColor: colors.border }]}
              >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.statsGrid}>
          <StatCard
            ...
            value={stats.totalSatsSent.toLocaleString()}
            icon="flash"
            colors={colors}
          />
          <StatCard
            label="Episodes Boosted"
            value={String(stats.episodesBoosted.length)}
            icon="radio"
            colors={colors}
          />
          <StatCard
          ...
          {stats.totalXrpSent > 0 && (
            <StatCard
              label="XRP Sent"
              value={stats.totalXrpSent.toFixed(4)}
              icon="diamond"
              colors={colors}
            />
          )}
      ...
      <View style={styles.section}>
        ...
        <Pressable
          ...
          style={[styles.p2pBtn, { borderColor: colors.border }]}
        >

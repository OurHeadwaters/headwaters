...
import { Pencil, Trash2, Plus, X, Check, Loader2, Quote, Lock } from "lucide-react";
...
export function AdminNuggets() {
  ...
  if (!auth?.user) {
    return <AdminLoginWall returnTo="/admin/nuggets" />;
  }

  return <AdminNuggetsContent />;
}

function AdminNuggetsContent() {

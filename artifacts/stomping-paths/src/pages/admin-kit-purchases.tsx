...
import { Package, Loader2, DollarSign, Mail, MessageSquare, Lock } from "lucide-react";
...
export function AdminKitPurchases() {
  ...
  if (!auth?.user) {
    return <AdminLoginWall returnTo="/admin/kit-purchases" />;
  }

  return <AdminKitPurchasesContent />;
}

function AdminKitPurchasesContent() {

...
import { CheckCircle, AlertTriangle, RefreshCw, ChevronDown, ChevronUp, Activity, Lock } from "lucide-react";
...
export function AdminSeriesHealth() {
  ...
  if (!auth?.user) {
    return <AdminLoginWall returnTo="/admin/series-health" />;
  }

  return <AdminSeriesHealthContent />;
}

function AdminSeriesHealthContent() {

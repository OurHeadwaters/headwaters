...
import {
  ...
  Copy, ExternalLink, AlertCircle, CalendarDays, DollarSign, Lock,
} from "lucide-react";
...
export function AdminExpertListings() {
  ...
  if (!auth?.user) {
    return <AdminLoginWall returnTo="/admin/expert-listings" />;
  }

  return <AdminExpertListingsContent />;
}

function AdminExpertListingsContent() {
